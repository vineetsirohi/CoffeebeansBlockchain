...
contract('SupplyChain', function (accounts) {
    ...
    it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async () => {
        ...
        // Using openzeppelin's test-helpers for verifying events. See below
        ...
        expectEvent(harvestItem, 'Harvested', {
            upc: upc + '' // expects string
        });
    ...
    it("Testing smart contract function processItem() that allows a farmer to process coffee", async function () {
        ...
        expectEvent(processItem, 'Processed', {
            upc: upc + ''
        });
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async () => {
        ...
        const buyItem = await supplyChain.buyItem(upc, {
            from: distributorID,
            value: productPrice + ''
        })

        // Watch the emitted event Sold()
        expectEvent(buyItem, 'Sold', {
            upc: upc + ''
        });
    ...
    it("Testing smart contract function shipItem() that allows a distributor to ship coffee", async () => {
        ...
        const shipItem = await supplyChain.shipItem(upc, {
            from: distributorID
        })

        // Watch the emitted event Shipped()
        expectEvent(shipItem, 'Shipped', {
            upc: upc + ''
        });
    ...
    it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async () => {
        ...
        const receiveItem = await supplyChain.receiveItem(upc, {
            from: retailerID
        })

        // Watch the emitted event Received()
        expectEvent(receiveItem, 'Received', {
            upc: upc + ''
        });
    ...
    it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async () => {
        ...
        // Mark an item as Received by calling function receiveItem()
        const purchaseItem = await supplyChain.purchaseItem(upc, {
            from: consumerID
        })

        // Watch the emitted event Purchased()
        expectEvent(purchaseItem, 'Purchased', {
            upc: upc + ''
        });
