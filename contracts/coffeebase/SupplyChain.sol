    ...
    Ownable
{
    ...
    function addRoles(
        ...
        address distributorAccount,
        address retailerAccount,
        address consumerAccount
    ) public onlyOwner {
        items[_upc].originFarmerID = farmerAccount;
        addFarmer(farmerAccount);

        items[_upc].distributorID = distributorAccount;
        addDistributor(distributorAccount);

        items[_upc].retailerID = retailerAccount;
        addRetailer(retailerAccount);

        items[_upc].consumerID = consumerAccount;
        addConsumer(consumerAccount);
    }
}
